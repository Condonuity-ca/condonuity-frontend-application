...
@Component({
  selector: 'vendor-external',
  templateUrl: './vendor-external.component.html',
  styleUrls: ['./vendor-external.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class VendorExternalComponent implements OnInit, OnDestroy {
  @Input()
  ...
  openCreateThreadExternalDialog() {
        ...
        const CreateThreadExternalDialogRef = this.dialog.open(CreateThreadExternalDialog,{width: '50%',height:'auto'});


        CreateThreadExternalDialogRef.afterClosed().subscribe(result => {
